...
public class GraphVizAPI {
    ...
    private byte[] get_img_stream(File dot, String type) {
        ...
        try {
            ...
            String[] args = { "C:\\Program Files\\Graphviz\\bin\\dot.exe", "-T" + type,
    ...
    private File writeDotSourceToFile(String str) throws java.io.IOException {
        ...
        try {
            ...
            // File f = new File(GraphVizAPI.TEMP_DIR);
            temp = File.createTempFile("dorrr", ".dot", new File(GraphVizAPI.TEMP_DIR));
